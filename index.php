...
<h1>
    ...
    <a style="<?php if((new DateTime($dateStart))->modify('+1 day') > new DateTime()): ?>visibility: hidden;<?php endif; ?>" href="/<?php if(!$tomorowIsToday): ?><?php echo date_format((new DateTime($dateStart))->modify('+1 day'), "Ymd"); ?>/<?php endif; ?><?php echo $mode ?>.html">
        <span aria-hidden="true">></span>
