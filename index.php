...
<dialog id="helpModal">
    ...
    <p>Chaque nuit l'historique des données présentées sur cette page sont <a href="/export/">exportées au format CSV</a>. Ces données sont librement exploitables dans le respect de la licence <a href="https://opendatacommons.org/licenses/odbl/summary/">ODbL</a>.</p>
