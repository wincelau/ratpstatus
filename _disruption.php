...
<li><span class="<?php echo $i->getColorClass() ?>"></span> <strong><?php echo $i->getDateStart()->format("H\hi") ?></strong> <span style="opacity: <?php if(!$i->isInProgress()): ?>0.75<?php endif; ?>;"><?php if($ii->isInProgress()): ?>⏳ <?php endif; ?><?php echo $i->getDurationText(); ?></span><span><br /><br /></span><?php echo $i->getTitle() ?>
