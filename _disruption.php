...
<h4><img src="<?php echo $disruption->getLigne()->getImage(); ?>"/><span><?php if($disruption->isPast()): ?>De <?php echo $disruption->getDateStart()->format("H\hi") ?> à <?php echo $disruption->getDateEnd()->format("H\hi") ?><?php elseif($disruption->isInProgress()): ?>Depuis <?php echo $disruption->getDateStart()->format("H\hi") ?><?php endif; ?></span><?php if($disruption->getOrigine()): ?><span class="mobile_hidden" title="<?php echo $disruption->getOrigine() ?>">&nbsp;: <?php echo $disruption->getOrigine() ?></span><?php endif; ?><?php if(strpos($disruption->getId(), 'distruption_id_calculate:') !== false && $disruption->getDateStart() > new DateTime('2024-11-28')): ?><span style="opacity: 0.5; float: right;"> ⚠️</span><?php endif; ?><span><?php if($disruption->isInProgress()): ?>⏳ <?php endif; ?><?php echo $disruption->getDurationText(); ?></span><?php if($disruption->getOrigine()): ?><span class="mobile_visible"><?php echo $disruption->getOrigine() ?></span><?php endif; ?></h4>
<ul>
